...
WEIGHTS_PATH = "config/yolov3.weights"  # Path to yolov3.weights
CONFIG_PATH = "config/yolov3.cfg"       # Path to yolov3.cfg
NAMES_PATH = "data/coco.names"        # Path to coco.names
